...
#include <rev/CANSparkMax.h> //include vendor rep! 

#include <AHRS.h> //install navex vendor rep 

#include <frc/PowerDistribution.h> //this is deprecated! see 2022 WPILIB Change Log
